  ...
  return (
    <div key={title} className="flex w-full items-center justify-center">
      <motion.button
        ...
        className="!rounded-full flex h-9 w-9 items-center justify-center border bg-white font-medium text-sm outline-none hover:bg-zinc-100 dark:bg-[#121212]"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId={`${title}-wrapper`}
            className={cn(
              "!z-[9000] fixed bottom-14 left-[41%] overflow-hidden bg-muted p-1 pt-2 shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_1px_2px_rgba(0,0,0,0.04)] outline-none",
              wrapperClassName
            )}
            ref={ref}
      ...
      {/*    className={*/}
      {/*        open*/}
      {/*            ? 'xbg-[rgba(250,250,250,.3)] xbackdrop-blur-sm fixed inset-0 !z-[4000] transition duration-700'*/}
      {/*            : ''*/}
      {/*    }*/}
      {/*></div>*/}
    </div>
